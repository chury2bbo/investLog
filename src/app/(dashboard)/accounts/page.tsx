              ...
              <Card key={acc.id} onClick={() => router.push(`/accounts/${acc.id}`)}>
                ...
                <div className="flex justify-end gap-2 mt-3 pt-3 border-t border-[var(--color-g100)] dark:border-[var(--color-border)]">
                  ...
                  <button
                    ...
                    className="p-2.5 rounded-lg bg-[var(--color-g100)] dark:bg-[var(--color-border)] text-[var(--color-g500)] dark:text-[var(--color-muted)] hover:bg-[var(--color-g200)] dark:hover:bg-(--color-hover) transition-colors cursor-pointer"
                  >
